...
void Marlim_CalculateMixtureThermodynamicCondition(double dFlashPressure, double dFlashTemperature, int iNComp, double* oMW, double* oZ, double* oTc,
		...
		int iLiqDensityCalculationMethod, int iVapDensityCalculationMethod,
		double dGivenInitialBeta, double* oGivenInitialLiqComposition, double* oGivenInitialVapComposition,
...
void Marlim_CalculateOilFormationVolumeFactor(double dPressure, double dTemperature, int iNComp, double* oTc, double* oPc, double* oW, double* oKij,
	...
	extern "C"
#endif
void Marlim_CorrectBlackOilRsWithPVTAnalysisRegression(int iRsRegressionModelType, double dRsRegressionA, double dRsRegressionB,
                double dRsCalculated_Arg, double dSaturationPressure, double dRGO_RsUpperLimit, double dLocalPressure,
                double* dRsCorrected);

#ifdef __cplusplus
	extern "C"
#endif
void Marlim_FitBlackOilPVTAnalysisCalibrationModels(int iNPVTPoints, double* oExpPressures_Arg, double* oExpRs_Arg, double dExpTemperature, double dPSEP_VB, 
				double dTSEP_VB, double dAPI, double dRGO_Arg, double dDeng, int* oTestedRsCorrelations, double* oCorrelationsRs, int* iBestRsCorrelation,
				int* iRsRegressionModelType, double* dRsRegressionA, double* dRsRegressionB, double* oCorrectedRs, double* oCalibrationInfoSummary, int* iIER);
