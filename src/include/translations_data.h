...
static const char TRANSLATIONS_JSON_RAW[] = R"TJSON(
{
  "keys": {
    ...
    "waxData": "dadosParafina",
    "oilDensity": "rhoo",
    "waterPhaseOutputDensity": "rhoa",
    "conductivityWeighting": "ponderaCond",
    "oilFlowStd": "QOstd",
    "beggsBrill": "correlacaoBB",
    "stdOilWaterFlowRate": "QOWstd",
    "gasInventory": "inventarioGas",
    "liquidInventory": "inventarioLiq",
    "printTime": "tempoImpres",
    "unitCellDetail": "detalheCelulaUnitaria",
    "user": "usuario"
  },
  "values": {
