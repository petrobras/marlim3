...
public:
    ...
    bool checkHidratoG(long double P, long double T);

    long double TurnerHidratoG(long double P, long double T, long double P_eq, long double T_eq,
    ...
    long double Euler1ordemGasG(int i, long double j_G, long double taxaCinetica,
                               long double A, long double MM_g);

    long double Euler1ordemAguaG(int i, long double j_W, long double taxaCinetica,
                                long double A, long double eta, long double MM_w);

    long double Euler1ordemHidratoG(long double j_H, long double taxaCinetica,
...
private:
    ...
    long double fracFWcarregada; //chris - Hidratos
    ...
    long double interpolarG(long double x, const std::vector<long double>& xData, const std::vector<long double>& yData);


    std::tuple<std::vector<long double>, std::vector<long double>> gerarCurvaComInibidorG(
