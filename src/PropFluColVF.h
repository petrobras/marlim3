...
class ProFluColVF{
    ...
    ProFluColVF(double=1000,double=0,double=0,double=1e-6,double=4000,double=1,double=0,
			...
			int vtab=0, int vnTemp=0, int vnNew=0, int vnaoN=0 ); //construtor default
    ProFluColVF(const ProFluColVF&); //construtor por c�pia
	...
	double MasEspFlu(double pres/*pressao kgf/cm2*/,
 	...
 	double VisFlu(double pres/*pressao kgf/cm2*/,
 			double temp/*temperatura C*/, double deform=0) const;//retorna a viscosidade cP
 	double VisGas(double pres/*pressao kgf/cm2*/,
